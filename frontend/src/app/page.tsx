...
export default function Home() {
  ...
  return (
    /* FULL-WIDTH WRAPPER: Allows background effects to span edge-to-edge */
    <div className="relative min-h-screen">
      
      {/* Full-screen background effects */}
      <PixelDust />

      {/* CONSTRAINED CONTENT WRAPPER: Keeps text/cards at 1280px (max-w-7xl) */}
      <div className="relative z-10 max-w-7xl mx-auto space-y-32">
        ...
        <section className="relative z-10 space-y-10 pb-10">
          <div className="text-center">
            ...
            <h2 className="text-4xl font-bold text-white mt-3 tracking-tight">Get Started</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            ...
            <a href="/dashboard" className="group bg-gray-900 p-8 rounded-2xl border border-gray-800 hover:border-blue-500/50 hover:bg-gray-800/50 transition-all duration-300 animate-fade-in-up" style={{ animationDelay: '1.3s' }}>
              <h3 className="text-xl font-semibold text-white mb-3 flex items-center gap-2">
                Operations Dashboard <ArrowRight className="h-4 w-4 opacity-0 group-hover:opacity-100 transition-opacity text-blue-400" />
              </h3>
              <p className="text-gray-400 text-sm leading-relaxed">For senders and couriers. Create shipments, manage logistics, and update parcel milestones in real-time.</p>
            </a>

            <a href="/track" className="group bg-gray-900 p-8 rounded-2xl border border-gray-800 hover:border-purple-500/50 hover:bg-gray-800/50 transition-all duration-300 animate-fade-in-up" style={{ animationDelay: '1.4s' }}>
              <h3 className="text-xl font-semibold text-white mb-3 flex items-center gap-2">
                Public Tracker <ArrowRight className="h-4 w-4 opacity-0 group-hover:opacity-100 transition-opacity text-purple-400" />
              </h3>
              <p className="text-gray-400 text-sm leading-relaxed">For receivers. Enter a tracking ID to view the real-time status, location history, and delivery estimates.</p>
            </a>
